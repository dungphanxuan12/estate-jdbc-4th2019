...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel bg-secondary" id="main-panel">
      <!-- Navbar -->
      ...
      <div class="panel-header">
        <div class="header text-center">
          ...
          <p class="category">Project learning from
            <a target="_blank" href="http://laptrinhjavaweb.com">laptrinhjavaweb.com</a>
          </p>
        </div>
      </div>
      <div class="content">
                ...
                <form>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label>TÃªn tÃ²a nhÃ </label>
                        <input type="text" class="form-control" placeholder="Company" value="Creative Code Inc.">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Diá»n tÃ­ch sÃ n</label>
                        <input type="text" class="form-control" placeholder="Username" value="michael23">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Quáº­n hiá»n cÃ³</label>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>PhÆ°á»ng</label>
                        <input type="text" class="form-control" placeholder="Company" value="Mike">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>ÄÆ°á»ng</label>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>GiÃ¡ dá»ch vá»¥</label>
                        <input type="text" class="form-control" placeholder="City" value="Mike">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>GiÃ¡ giá»¯ Ã´ tÃ´</label>
                        <input type="text" class="form-control" placeholder="Country" value="Andrew">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>GiÃ¡ giá»¯ xe mÃ¡y</label>
                        <input type="number" class="form-control" placeholder="ZIP Code">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Äiá»n thoáº¡i quáº£n lÃ½</label>
                        <input type="text" class="form-control" placeholder="City" value="Mike">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
